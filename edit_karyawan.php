...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_update = "UPDATE users SET username = '$username', email = '$email', password = '$password' WHERE id = $id";
            ...
            <div class="page-content">
                ...
                <div class="page-inner no-page-title">
                    <div id="main-wrapper">
                        ...
                        <h5 class="page-desc">Edit data karyawan sebagai pengelolaan data karyawan</h5>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <form action="edit_karyawan.php" method="POST">
                                                ...
                                                <a href="list_karyawan.php"><button class="btn btn-danger">Batal</button></a>
                                            </form>
                                        </div>      
                                    </div>
                                </div>

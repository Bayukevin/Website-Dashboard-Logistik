...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Mendapatkan informasi barang masuk berdasarkan ID yang dipilih
    $sql_select = "SELECT * FROM barang_masuk WHERE id_barang = $id_barang_masuk";
    $result_select = $conn->query($sql_select);

    if ($result_select->num_rows == 1) {
        $row = $result_select->fetch_assoc();
        $sisa_barang = $row['jumlah_barang'] - $jumlah_barang_keluar;

        // Update jumlah sisa barang pada barang_masuk
        $sql_update = "UPDATE barang_masuk SET jumlah_barang = $sisa_barang WHERE id_barang = $id_barang_masuk";
        $conn->query($sql_update);

        // Insert data ke dalam tabel barang_keluar
        $sql_insert = "INSERT INTO barang_keluar (id_barang_masuk, jumlah_barang) VALUES ($id_barang_masuk, $jumlah_barang_keluar)";
        ...
        echo "Barang masuk tidak ditemukan.";
    }
}

// Mendapatkan data barang masuk untuk dropdown
                ...
                <div class="page-inner no-page-title">
                    <div id="main-wrapper">
                        <div class="content-header">
                            ...
                            <h1 class="page-title">Tambah Data Barang Keluar</h1>
                        </div>
                        <h5 class="page-desc">Input data barang keluar sebagai stok sisa barang</h5>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <form action="add_barang_keluar.php" method="POST">
                                                <div class="mb-3">
                                                    <label for="exampleFormControlInput1" class="form-label">Nama Barang</label>
                                                    <select class="form-control" aria-label="Default select example" id="id_barang_masuk" name="id_barang_masuk">
                                                        ...
                                                        if ($result_barang_masuk->num_rows > 0) {
                                                            ...
                                                            echo "<option value=''>Tidak ada barang masuk</option>";
                                                        }
                                                        ?>
                                                    </select>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="jumlah_barang_keluar" name="jumlah_barang_keluar" placeholder="Masukkan Jumlah Barang">
                                                </div>
                                                <button class="btn btn-primary" type="submit">Tambah Barang</button>
                                                <a href="list_barang_keluar.php"><button class="btn btn-danger">Batal</button></a>
                                            </form>
                                        </div>      
                                    </div>
                                </div>

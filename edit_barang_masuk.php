...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_GET['id'])) {
    ...
    // Query untuk memperbarui data barang masuk di tabel
    $sql = "UPDATE barang_masuk SET nama_barang = '$nama_barang', jenis_barang = '$jenis_barang', jumlah_barang = '$jumlah_barang' WHERE id_barang = $id_barang";
    
    if ($conn->query($sql) === TRUE) {
        header("Location: list_barang_masuk.php"); // Redirect ke halaman list_barang_masuk setelah data berhasil diperbarui
        exit;
    } else {
...
// Ambil data barang masuk berdasarkan ID yang dipilih untuk diedit
if (isset($_GET['id'])) {
    $id_barang = $_GET['id'];
    $sql = "SELECT * FROM barang_masuk WHERE id_barang = $id_barang";
    $result = $conn->query($sql);
                ...
                <div class="page-inner no-page-title">
                    <div id="main-wrapper">
                        <div class="content-header">
                            ...
                            <h1 class="page-title">Edit Data Barang Masuk</h1>
                        </div>
                        <h5 class="page-desc">Edit data barang masuk sebagai stok barang</h5>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <form action="edit_barang_masuk.php?id=<?php echo $id_barang; ?>" method="POST">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="jumlah_barang" name="jumlah_barang" value="<?php echo $jumlah_barang; ?>">
                                                </div>
                                                <button class="btn btn-primary" type="submit">Update Data</button>
                                                <a href="list_barang_masuk.php"><button class="btn btn-danger">Batal</button></a>
                                            </form>
                                        </div>      
                                    </div>
                                </div>

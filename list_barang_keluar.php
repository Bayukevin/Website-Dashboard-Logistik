            ...
            <div class="page-content">
                ...
                <div class="page-inner no-page-title">
                    <div id="main-wrapper">
                        ...
                        <h5 class="page-desc">Tabel data barang yang keluar dari gudang</h5>
                        <div class="divider"></div>
                        
                        <div class="row">
                            <div class="col-xl">
                            <a href="add_barang_keluar.php"><button class="btn btn-primary mb-3">Tambah Barang</button></a>
                                <div class="card">
                                    <div class="card-body">
                                                    ...
                                                    <?php
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                echo "<td>
                                                                        <a href='edit_barang_keluar.php?id=".$row['id_barang_keluar']."'><button class='btn btn-warning'>Edit</button></a> 
                                                                        <a href='delete_barang_keluar.php?id=".$row['id_barang_keluar']."' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data?\")'><button class='btn btn-danger'>Hapus</button></a>
                                                                    </td>";
                                                                echo "</tr>";
                                                            }
                                                        } else {

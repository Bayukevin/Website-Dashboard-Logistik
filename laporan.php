            ...
            <div class="page-content">
                ...
                <div class="page-inner no-page-title">
                    <div id="main-wrapper">
                        ...
                        <h5 class="page-desc">Laporan keseluruhan data barang masuk dan barang keluar</h5>
                        <div class="divider"></div>
                        
                        <div class="row">
                            <div class="col-xl">
                                <a href="laporan_pdf.php"><button class="btn btn-primary mb-3"><i class="menu-icon icon-save"></i> Cetak PDF</button></a>
                                <div class="card">
                                    <div class="card-body">

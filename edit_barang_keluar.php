...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_update = "UPDATE barang_keluar SET jumlah_barang = $jumlah_barang_keluar WHERE id_barang_keluar = $id_barang_keluar";
...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $sql_select = "SELECT * FROM barang_keluar WHERE id_barang_keluar = $id_barang_keluar";
    $result = $conn->query($sql_select);

    if ($result->num_rows == 1) {
        $row = $result->fetch_assoc();
        $id_barang_keluar = $row['id_barang_keluar'];
        $jumlah_barang_keluar = $row['jumlah_barang'];
    } else {
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="navbar-header">
                                <div class="logo-sm">
                                    ...
                                    <a class="logo-box" href="#"><span>Logistic</span></a>
                                </div>
                ...
                <div class="page-inner no-page-title">
                    <div id="main-wrapper">
                        <div class="content-header">
                            ...
                            <h1 class="page-title">Edit Data Barang Keluar</h1>
                        </div>
                        <h5 class="page-desc">Edit data barang keluar sebagai stok sisa barang</h5>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <form action="edit_barang_keluar.php" method="POST">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="jumlah_barang_keluar" name="jumlah_barang_keluar" value="<?php echo $jumlah_barang_keluar; ?>">
                                                </div>
